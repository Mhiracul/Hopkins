...
const Product = () => {
  return (
    <div id="product" className="bg-white h-full py-20 w-full">
      <h1 className="text-black pb-20 text-xl font-bold uppercase text-center">
        Product
      </h1>
      ...
      <div className="container mx-auto  lg:px-32 md:px-10 px-4">
        <div className="grid lg:grid-cols-2  mt-10 grid-cols-1 gap-20">
          <div className="flex flex-col lg:flex-col-reverse md:items-start items-center">
            ...
            <div className="flex md:flex-row flex-col gap-5">
              <Image
                src={Print3}
                alt="logo"
                className="mt-3 object-cover max-w-full max-h-[200px]"
              />
              <Image
                src={Print4}
                alt="logo"
                className="mt-1 object-cover max-w-full max-h-[200px]"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8 md:items-start items-center">
            ...
            <p className="text-base  md:text-start text-center font-normal text-black">
